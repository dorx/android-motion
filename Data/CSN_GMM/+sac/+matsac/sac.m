...
%fid=fopen(filename, 'rb'); % this was the original. Didn't work on some
%SAC files, e.g. those from WILBER
%
%fid=fopen(filename, 'r', 'b'); % r,b is for "read", "big-endian" works. MF
fid=fopen(filename, 'r'); % r,b is for "read", "big-endian" works. MF
